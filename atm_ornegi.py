...
while True:
    ...
    if (işlem == "q"):
        ...
        bakiye += miktar #Sağdaki değişkeni soldaki değişken ile topluyor.
    elif (işlem == "3"):
        miktar = int(input("Çekmek istediğiniz tutar:"))
        if (bakiye - miktar < 0 ): #Miktar bakiyeden büyükse.
            print("Bu kadar para çekemezsiniz...")
            print("Bakiyeniz {} tldir".format(bakiye))
            continue
        bakiye -= miktar  # Sağdaki değişkeni soldaki değişkenden çıkarıyor.
